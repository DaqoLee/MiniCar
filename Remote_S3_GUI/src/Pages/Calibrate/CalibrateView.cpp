...
void CalibrateView::Create(lv_obj_t* root)
{
...
void CalibrateView::TopInfo_Create(lv_obj_t* par)
{
...
void CalibrateView::BottomInfo_Create(lv_obj_t* par)
{
    lv_obj_t* cont = lv_obj_create(par);
    lv_obj_remove_style_all(cont);
...
void CalibrateView::SubInfoGrp_Create(lv_obj_t* par, SubInfo_t* info, const char* unitText)
{
    lv_obj_t* cont = lv_obj_create(par);
    lv_obj_remove_style_all(cont);
...
lv_obj_t* CalibrateView::Btn_Create(lv_obj_t* par, const void* img_src, lv_coord_t x_ofs)
{
    lv_obj_t* obj = lv_obj_create(par);
...
void CalibrateView::AppearAnimStart(bool reverse)
{
